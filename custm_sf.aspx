			...
			<div id="dbbs" class='dbbs' >
				<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
					<tr style='color:White; background:#003366;' >
						...
						<td align="center" style="width:20%;"><a id='lblComp'> </a></td>
						<td align="center"><a id='lblMemo'> </a></td>
						<td align="center" style="width:2%;"><a id='lblEnda'> </a></td>
					</tr>
					<tr  style='background:#cad3ff;'>
						...
						<td><input class="txt" id="txtComp.*" type="text" style="width:98%;"/></td>
						<td><input class="txt" id="txtMemo.*" type="text" style="width:98%;"/></td>
						<td><input class="txt" id="chkEnda.*" type="checkbox"/></td>
					</tr>
				</table>
			</div>
		</div>
