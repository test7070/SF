	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_gfPost() {
				...
				string+='<td id="cucu_memo" align="center" style="width:250px; color:black;">備註&nbsp;&nbsp;<input id="btnCubs" type="button" style="font-size: medium; font-weight: bold;" value="餘料入庫"/></td>';
				string+='</tr>';
				string+='</table>';
				$('#cucu').html(string);
				...
				//string+='<td id="cucu_hmount" align="center" style="width:90px; color:black;">支數</td>';
				string+='<td id="cucu_weight" align="center" style="width:90px; color:black;">重量</td>';
				string+='<td id="cucu_memo" align="center" style="width:250px; color:black;">備註&nbsp;&nbsp;<input id="btnCubs2" type="button" style="font-size: medium; font-weight: bold;" value="餘料入庫"/></td>';
				string+='</tr>';
				string+='</table>';
				$('#cucu').append(string);
            ...
            function q_gtPost(t_name) {
				switch (t_name) {
					case 'init':
						...
						string+='<td id="cucs_style" title="加工型式" align="center" style="width:50px; color:black;">加工型式</td>';
						string+='<td id="cucs_dime" title="彎勾" align="center" style="width:50px; color:black;">彎勾</td>';
						string+='<td id="cucs_width" title="長度" align="center" style="width:50px; color:black;">長度</td>';
						string+='<td id="cucs_radius" title="彎勾" align="center" style="width:50px; color:black;">彎勾</td>';
						string+='<td id="cucs_pic" title="形狀" align="center" style="width:50px; color:black;">形狀</td>';
						...
						string+='<td id="cucs_scolor" title="分區" align="center" style="width:110px; color:black;">分區</td>';
						string+='<td id="cucs_memo" title="備註" align="center" style="width:110px; color:black;">備註</td>';
					...
					case 'importcucs':
							...
							for(var j=0;j<bbsrow;j++){
								...
								for(var i =0 ;i<as.length;i++){
									if(as[i].noa==$('#cucs_noa'+j).text() && as[i].noq==$('#cucs_noq'+j).text()){
										...
										$('#cucs_style'+j).text(as[i].style);
										$('#cucs_dime'+j).text(as[i].dime);
										$('#cucs_width'+j).text(as[i].width);
										$('#cucs_radius'+j).text(as[i].radius);
										$('#cucs_pic'+j).text();
						...
						for(var i=0;i<as.length;i++){
							if(table_noa!='' && table_noa!=as[i].noa){ //不同案號 空依格
								...
								string+='<td id="cucs_style'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'"></td>';
								string+='<td id="cucs_dime'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'"></td>';
								string+='<td id="cucs_width'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'"></td>';
							...
							string+='<td id="cucs_style'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'">'+as[i].style+'</td>';
							string+='<td id="cucs_dime'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'">'+as[i].dime+'</td>';
							string+='<td id="cucs_width'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'">'+as[i].width+'</td>';
							string+='<td id="cucs_radius'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'">'+as[i].radius+'</td>';
							string+='<td id="cucs_pic'+(i+bbsrow)+'" style="text-align: center;color:'+t_color[(i+bbsrow)%t_color.length]+'"></td>';
